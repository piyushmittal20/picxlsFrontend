...
import { addCity, addcountry, addState, detailCity, detailCountry, detailState, editCity, editCountry, editState, listCity, listCountry, listState } from '../service';

export const getAllCountries = () => async(dispatch, getState) => {
    try {
        dispatch({type: ADMIN_COUNTRYLIST_REQUEST})

        const {data: {countries}} = await axios.get(`${listCountry}/country`)
...
export const getCountry = (id) => async(dispatch, getState) => {
    try {
        ...
        const {data: {country}} = await axios.get(`${detailCountry}/country/${id}`)
...
export const createCountry = (newCountry) => async(dispatch, getState) => {
    try {
        ...
        const {data: {savedCountry}} = await axios.post(`${addcountry}/country`, newCountry, config)
...
export const updateCountryStatus = (country, id) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.put(`https://picxls-testing.herokuapp.com/api/admin/countryStatus/${id}`, country, config);
...
export const getAllStates = () => async(dispatch, getState) => {
    try {
        ...
        const {data: {states}} = await axios.get(`${listState}/state`)
...
export const createState = (newState) => async(dispatch, getState) => {
    try {
        ...
        const {data: {state}} = await axios.post(`${addState}/state`,newState, config)
...
export const deleteState = (id) => async(dispatch, getState) => {
    try {
        ...
        const {data: {state}} = await axios.delete(`https://picxls-testing.herokuapp.com/api/admin/state/${id}`)
...
export const updateStateStatus = (state, id) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.put(`https://picxls-testing.herokuapp.com/api/admin/stateStatus/${id}`, state, config)
...
export const updateState = (updatedState) => async(dispatch, getState) => {
    try {
        ...
        const {data: {savedState}} = await axios.put(`${editState}/state/${updatedState._id}`, updatedState, config);
...
export const getCities = () => async(dispatch, getState) => {
    try {
        ...
        const {data: {cities}} = await axios.get(`${listCity}/city`)
...
export const createCity = (newCity) => async(dispatch, getState) => {
    try {
        ...
        const {data: {savedCity}} = await axios.post(`${addCity}/city`, newCity, config)
...
export const deleteCity = (id) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.delete(`https://picxls-testing.herokuapp.com/api/admin/city/${id}`)
...
export const updateCityStatus = (city, id) => async(dispatch, getState) => {
    try {
        ...
        const {data} = await axios.put(`https://picxls-testing.herokuapp.com/api/admin/cityStatus/${id}`, city, config)
...
export const updateCity = (city) => async(dispatch, getState) => {
    try {
        ...
        const {data: {savedCity}} = await axios.put(`${editCity}/city/${city._id}`, config, city)
