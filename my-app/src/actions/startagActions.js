...
export const getAllStartag = () => async(dispatch, getState) => {
    try {
        ...
        const {data: {startags}} = await axios.get(`${startagList}/startags`)
...
export const createStartag = (startag) => async(dispatch, getState) => {
    try {
        ...
        const {data: {savedStartag}} = await axios.post(`${addStartag}/startag`, startag)
...
export const getStartag = (id) => async(dispatch, getState) => {
    try {
        ...
        const {data: {startag}} = await axios.get(`${startagDetail}/startag/${id}`)
...
export const updateStartag = (startag) => async(dispatch, getState) => {
    ...
    try {
        ...
        const {data: {savedStartag}} = await axios.put(`${startagUpdate}/startag/${startag._id}`, startag, config)
